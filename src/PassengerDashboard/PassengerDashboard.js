...
<Card sx={{ 
  ...
  <Grid container justify="center">
   ...
   color="error" 
  onClick={()=>navigate(`/passenger/passengersavebooking?trainId=${train.trainId}&passengerEmail=${email}&source=${source}&destination=${destination}&journeydate=${journeydate}`)}
    >BOOK</Button>
</Grid>
  </CardActions>
</Card>
